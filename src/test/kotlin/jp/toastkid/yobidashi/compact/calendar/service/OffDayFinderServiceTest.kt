...
internal class OffDayFinderServiceTest {
    ...
    @Test
    fun testJune() {
        assertFalse(offDayFinderService(2020, 6, 4, DayOfWeek.THURSDAY.value))
    ...
    fun testVernalEquinoxDay() {
        assertTrue(offDayFinderService(2020, 3, 20, DayOfWeek.FRIDAY.value))
    ...
    fun testAutumnalEquinoxDay() {
        assertTrue(offDayFinderService(2020, 9, 22, DayOfWeek.FRIDAY.value))
    ...
    fun testSpecialCase2019() {
        ...
        assertTrue(offDayFinderService(2019, 5, 1, DayOfWeek.WEDNESDAY.value))
    ...
    fun testSpecialCase2020October() {
        ...
        assertFalse(offDayFinderService(2020, 10, 14, DayOfWeek.WEDNESDAY.value))
    ...
    fun testMoveableCase() {
        ...
        assertTrue(offDayFinderService(2020, 9, 21, DayOfWeek.MONDAY.value))
    ...
    fun testUserOffDay() {
        ...
        assertTrue(offDayFinderService(2020, 12, 29, DayOfWeek.TUESDAY.value))
    ...
    @Test
    fun testMay6() {
        assertTrue(offDayFinderService(2020, 5, 6, DayOfWeek.WEDNESDAY.value))
    ...
    @Test
    fun testNov4() {
        assertTrue(offDayFinderService(2019, 11, 4, DayOfWeek.MONDAY.value))
    ...
    @Test
    fun testNormalDay() {
        assertFalse(offDayFinderService(2020, 12, 17, DayOfWeek.THURSDAY.value))
